...
public class VideoTest {
    ...
    public static void getPlayAuth() throws ClientException {
        ...
        //根据视频id获取视频播放凭证
        DefaultAcsClient defaultAcsClient = InitVideo.initVodClient("LTAI4GBnQpzPSCy81bBQdXWV", "A5kZE5skH1iahru2XgLDfgMxqGxOHM");

        GetVideoPlayAuthRequest request = new GetVideoPlayAuthRequest();
        request.setVideoId("172c137b90e748379342d52ebf9508e6");
